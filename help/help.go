...
type CommandHelp func(cur *warg.Command, helpInfo common.HelpInfo) warg.Action
type SectionHelp func(cur *section.SectionT, helpInfo common.HelpInfo) warg.Action
