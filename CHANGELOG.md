...
- TODO: finish Added `scalar.PointerTo` to bind how a scalar updates from flags/interfaces to a pre-existing variable. Still need to do this for dicts and slices, and test in envelope that it actually decreases friction (I think it will!)
